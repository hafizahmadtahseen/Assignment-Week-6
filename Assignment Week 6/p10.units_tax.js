...
if (units_consumed > 100 && units_consumed <= 200) {
    console.log(`Bill for consumed ${units_consumed} Units with 10% Tax =  ${units_consumed + units_consumed * 0.1}`);
}
else if (units_consumed > 200 && units_consumed <= 500) {
    console.log(`Bill for consumed ${units_consumed} Units with 15% Tax =  ${units_consumed + units_consumed * 0.15}`);
}
else if (units_consumed > 500) {
    console.log(`Bill for consumed ${units_consumed} Units with 10% Tax =  ${units_consumed + units_consumed * 0.25}`);
}
